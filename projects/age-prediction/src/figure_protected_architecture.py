...
def box(x,y,w,title,sub,c):
 a.add_patch(FancyBboxPatch((x,y),w,.85,boxstyle='round,pad=.03,rounding_size=.06',fc=c,ec='#CFCECE',lw=1.2))
...
a.text(.1,4.62,'Clock-preserving microbial residual fusion',fontsize=18,weight='bold')
